              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Total Views', style: TextStyle(color: Colors.blueGrey[900])),
                      Text('265K', style: TextStyle(color: Colors.blue[900], fontWeight: FontWeight.w700, fontSize: 34.0))
                    ],
                  ),
                  Material
                  (
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Shop Items', style: TextStyle(color: Colors.blueGrey[900])),
